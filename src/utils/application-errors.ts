...
export const BusinessErrorMap: Record<DataErrors, BusinessErrors> = {
    ...
    [DataErrors.OPENAI_API_ERROR]: BusinessErrors.OTHER_DATA_ERROR,
...
export function processOPENAIError(err: any): never {
    throw new DataError(DataErrors.OPENAI_API_ERROR, err);
}
